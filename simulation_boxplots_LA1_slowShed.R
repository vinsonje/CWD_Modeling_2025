...
# setwd("E:/CWD_Modeling/Metapop_Model/Simulation_outputs/LA05/randomSS_LA05_lowBR")
setwd("~/Desktop/CWD_Modeling")
randomSS.data = read.csv("randomSS_output_LA1_medBR_slowShed.csv")
...
allSS.LA1.data = rbind(noSS.data,  edgeSS.data, prioritySS.data, randomSS.data)
allSS.LA1.data$SS.strat = factor(allSS.LA1.data$SS.strat, levels = c("no SS", "random", "edge", "priority"), 
                                 order = TRUE)
...
setwd("~/Desktop/CWD_Modeling")
write.csv(allSS.LA1.data, "allSS_LA1_medBR_slowSS.strat_data.csv", row.names = FALSE)
...
#Final prevalence
########################
final.prev.aov = aov(final.prev.pcent~SS.strat, data = allSS.LA1.data.endemic)
summary(final.prev.aov)
TukeyHSD(final.prev.aov)
summary(kruskal.test(final.prev ~ SS.strat, data = allSS.LA1.data.endemic))

fp.means = aggregate(allSS.LA1.data.endemic, final.prev.pcent~SS.strat, mean)
pcent.change = NA
for(i in 2:4){
...
endemic.counts = as.data.frame(table(allSS.LA1.data.endemic$SS.strat))
names(endemic.counts) = c("SS.strat","count")

fp.plot = ggboxplot(allSS.LA1.data.endemic, x = "SS.strat", y = "final.prev.pcent", 
...
allSS.LA1.data.endemic.sub = subset(allSS.LA1.data.endemic, SS.strat != "no SS")
fp.means.sub = subset(fp.means, SS.strat != "no SS")
allSS.LA1.data.endemic.sub$SS.strat = factor(allSS.LA1.data.endemic.sub$SS.strat, levels = c("random", "edge", "priority"), 
                                 order = TRUE)
fp.plot.inset = ggboxplot(allSS.LA1.data.endemic.sub, x = "SS.strat", y = "final.prev.pcent", 
                          color = "black", fill = "SS.strat", palette = "jco") + 
  # stat_compare_means(comparisons = my_comparisons, label="p.signif") + 
  theme_cowplot() +
  ylab("final prevalence %") + xlab("SS strategy") + theme(legend.position = "none") + 
...
#final spread area
#########################
sa.means = aggregate(allSS.LA1.data.endemic, final.spread.area~SS.strat, mean)
pcent.change = NA
for(i in 2:4){
...
sa.plot = ggboxplot(allSS.LA1.data.endemic, x = "SS.strat", y = "final.spread.area", 
                    color = "black", fill = "SS.strat", palette = "jco") + 
  # stat_compare_means(comparisons = my_comparisons, label="p.signif") + 
  theme_cowplot() +
...
sa.plot.inset = ggboxplot(allSS.LA1.data.endemic.sub, x = "SS.strat", y = "final.spread.area", 
                          color = "black", fill = "SS.strat", palette = "jco") + 
  # stat_compare_means(comparisons = my_comparisons, label="p.signif") + 
  theme_cowplot() +
  ylab("final prevalence %") + xlab("SS strategy") + theme(legend.position = "none") + 
...
#prev rate
##################
pr.plot = ggboxplot(allSS.LA1.data.endemic, x = "SS.strat", y = "mean.prev.rate",
                    color = "black", fill = "SS.strat", palette = "jco") + 
...
#spread rate
##################
sr.plot = ggboxplot(allSS.LA1.data.endemic, x = "SS.strat", y = "spread.area.rate",
                    color = "black", fill = "SS.strat", palette = "jco") + 
  # stat_compare_means(comparisons = my_comparisons, label="p.signif") + theme_cowplot() +
...
##################
finalpop.plot = ggboxplot(allSS.LA1.data.endemic, x = "SS.strat", y = "final.pop",
                          color = "black", fill = "SS.strat", palette = "jco") + 
  # stat_compare_means(comparisons = my_comparisons, label="p.signif") + theme_cowplot() +
...
#I distance
##################
ID.plot = ggboxplot(allSS.LA1.data.endemic, x = "SS.strat", y = "mean.I.dist",
                    color = "black", fill = "SS.strat", palette = "jco") + 
  # stat_compare_means(comparisons = my_comparisons, label="p.signif") + theme_cowplot() +
  ylab("maximum infected distance from center") + xlab("SS strat") + 
  theme(legend.position = "none")

ggboxplot(allSS.LA1.data.endemic, x = "SS.strat", y = "std.I.dist",
          color = "black", fill = "SS.strat", palette = "jco") + 
  # stat_compare_means(comparisons = my_comparisons, label="p.signif") + theme_cowplot() +
  ylab("final population size") + xlab("SS strat") + 
  theme(legend.position = "none")
...
#######################
propinfcell.plot = ggboxplot(allSS.LA1.data.endemic, x = "SS strat", y = "final.number.I.cells",
                             color = "black", fill = "SS.strat", palette = "jco") + 
  # stat_compare_means(comparisons = my_comparisons, label="p.signif") + theme_cowplot() +
...
inffam.plot = ggboxplot(allSS.LA1.data.endemic, x = "SS.strat", y = "mean.inf.fams.prev",
                        color = "black", fill = "SS.strat", palette = "jco") + 
  # stat_compare_means(comparisons = my_comparisons, label="p.signif") + theme_cowplot() +
  ylab("inf. family prev.") + xlab("SS strategy") + 
  theme(legend.position = "none")

chull.plot = ggboxplot(allSS.LA1.data.endemic, x = "SS.strat", y = "mean.chull.fams.prev",
                       color = "black", fill = "SS.strat", palette = "jco") + 
  # stat_compare_means(comparisons = my_comparisons, label="p.signif") + theme_cowplot() +
  ylab("inf. chull family prev.") + xlab("SS strategy") + 
  theme(legend.position = "none")

chullI.plot = ggboxplot(allSS.LA1.data.endemic, x = "SS.strat", y = "mean.chull.fams.prev.I",
                        color = "black", fill = "SS.strat", palette = "jco") + 
  # stat_compare_means(comparisons = my_comparisons, label="p.signif") + theme_cowplot() +
  ylab("inf. chull family prev.") + xlab("SS strategy") + 
  theme(legend.position = "none")
